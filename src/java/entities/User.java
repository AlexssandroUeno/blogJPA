...
public class User implements Serializable {
    ...
    public String toString() {
        return "User{" + "idUser=" + idUser + ", name=" + name + ", username=" + username + ", email=" + email + ", password=" + password + ", assinaturaCollection=" + assinaturaCollection + ", postCollection=" + postCollection + ", idRole=" + idRole + '}';
    }
